            ...
            <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/20">
                        <div className="w-8 h-8 rounded-full bg-rose-600 flex items-center justify-center text-white font-bold text-xs">PS</div>
                        <span className={`text-sm font-semibold hidden md:block ${isScrolled ? 'text-gray-800' : 'text-white'}`}>Pruthvi</span>
