...
const HomePage = ({ onNavigate }) => {
    ...
    useEffect(() => {
        ...
        const updateCounter = () => {
            ...
            const currentVal = Math.floor(easedProgress * profilePercent);
    ...
    return (
        <div className={`home-page ${activeNavTip !== 'Home' ? 'hp-non-home' : ''}`} onMouseMove={handleMouseMove}>
            ...
            {/* ── FULL-SCREEN VIDEO BACKGROUND (temporarily removed) ── */}
                        ...
                        <div className="profile-dropdown sn-dropdown">
                            <div className="pd-user-card">
                                ...
                                <div className="pd-user-info">
                                    ...
                                    <span className="pd-meta">28 &nbsp;•&nbsp; Pune, Maharashtra</span>
            ...
            {activeNavTip === 'Home' && (
                <section className="hp-hero">
                    {/* ── New: Hero Carousel (3-Row Grid Marquee) ── */}
                    ...
                    <div className="hp-layout">
                        ...
                        {activeNavTip === 'Home' ? (
                            <div className="hp-left-col">
                                {/* ── PROFILE CARD ── */}
                                {/* ── PROFILE CARD WRAPPER TO ISOLATE AOS ── */}
                                <div>
                                    <div
                                            ...
                                            <div className="profile-card-body">
                                                ...
                                                <div className="pc-footer-row">
                                                    <div className="pc-hint-container">
                                                        <span className="pc-hint-icon">{displayPercent === 100 ? "🎉" : "⚡"}</span>
                                                    ...
                                                    {displayPercent < 100 ? (
                                                        ...
                                                        <button
                                                            className="pc-dashboard-btn premium"
                                                ...
                                                <div className="magic-card-content">
                                                    ...
                                                    <div className="pt-content">
                                                        <div className="pt-row-main">
                                                            ...
                                                            <div className="pt-rating">4.9 ★</div>
                                                        </div>
                        ...
                        {/* ── RIGHT SIDEBAR (Restored for Home only) ── */}
            ...
            < footer className="hp-footer" >
                <div className="hp-container footer-inner">
                    <p className="footer-copy">© 2026 ShubhVivah. All rights reserved.</p>
