...
const services = [
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1607190074257-dd4b7af0309f?w=1200&q=80'
    },
    {
    ...
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1478146059778-26028b07395a?w=1200&q=80'
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1611652022419-a9419f74343d?w=1200&q=80'
    },
    {
        ...
        img: 'https://images.unsplash.com/photo-1595981234058-a9302fb97229?w=1200&q=80'
    },
    {
...
const ServicesSection = () => {
    ...
    const [flyOrigin, setFlyOrigin] = useState(null); // which track item is hiding 
    ...
    /* ── Navigate ── */
    const goTo = useCallback((targetIdx, dir) => {
        if (targetIdx === active || slideDir !== 0) return;

        // If 'next', scale up card at offset 0 (track index 1)
        // If 'prev', scale up card at offset -1 (track index 0)
    ...
    const onUserNav = useCallback((dir) => {
        if (dir === 1) goNext();
        else goPrev();
        resetAuto();
        ...
        <section className="sv-section" id="services-section" ref={sectionRef}>
            ...
            {flyCard && (
                <div className="sv-fly" style={{
                    '--fy-t': `${flyCard.top}px`, '--fy-l': `${flyCard.left}px`,
                    '--fy-w': `${flyCard.w}px`, '--fy-h': `${flyCard.h}px`,
                }}>
            ...
            {/* 7 Cards Track — Slides left/right seamlessly */}
                        ...
                        return (
                            <div
                                ...
                                onClick={() => {
                                    ...
                                    if (offset > 0) onUserNav(1); // Click any right card goes next
                                    if (offset < 0) onUserNav(-1); // Click left card goes prev
                                }}
                                style={{
            ...
            {/* Bottom — absolutely positioned, never moves */}
